...
const REQUIRED = [
  ...
  'docs/04-desktop.md',
  'packages/evoscientist-plugin/package.json',
  'packages/evoscientist-plugin/cordis.patch.yml',
...
for (const dir of ['docs', 'README.md', 'packages/evoscientist-plugin/README.md']) {
