...
- 🛠️ **技能蒸馏** —— 从对话与记忆中自动提炼可复用技能，审核通过后即成为团队能力；技能市场一键浏览
...
- 🔍 **会话工具** —— 全文搜索、JSON / Markdown 导出、会话置顶与标签、重命名、删除、侧边对话、消息回填编辑、忙时队列编辑与转向
- 🛑 **运行控制** —— 一键停止当前回复，随时中断长任务
- 🛡️ **安全审批** —— 工具调用需人工批准时逐项展示（工具名 / 理由），Approve 或 Reject 一键决定；模型提问可在界面直接作答
